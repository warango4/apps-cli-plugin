...
func (opts *WorkloadOptions) WorkloadReadyWorkers(c *cli.Config, workload *cartov1alpha1.Workload, workers []wait.Worker) []wait.Worker {
...
func (opts *WorkloadOptions) WorkloadTailWorkers(c *cli.Config, workload *cartov1alpha1.Workload, workers []wait.Worker) []wait.Worker {
	workers = append(workers, func(ctx context.Context) error {
